...
export const PR_TITLE_MATURITY_LENGTH =
  process.env.PR_TITLE_MATURITY_LENGTH || "80";
export const COMMENT_MATURITY_LENGTH =
  process.env.COMMENT_MATURITY_LENGTH || "40";
